...
public class TSofPerticularElement {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedImage finalimg = rimg.getSubimage(xcoordinate+50, ycoordinate+40, wimg+80, himg+50);//performing cutting action subimage
		ImageIO.write(finalimg, "png", srcfile);
		File destfile = new File("./Screenshot/actiimg.png");//for storing in folder 
