...
public class TSofLogowithtext {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement ele = driver.findElement(By.xpath("//td[@id='logoContainer']"));
		...
		File destfile = new File("./Screenshot/actiimglogotxt.png");//for storing in folder 
